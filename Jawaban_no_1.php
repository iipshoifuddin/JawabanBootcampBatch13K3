<?php
function Biodata($nama1,$umur1)
{
	(String)$name='iip shoifuddin';
	(Integer)$age=25;
...
echo Biodata('iip shoifuddin',25); //--> untuk mengecek function Biodata();
$namajson='mybiodata2.json';
file_put_contents($namajson, Biodata('iip shoifuddin',25)); //--> membuat file JSON
echo "<a href=".$namajson.">Data JSON</a>";
?>